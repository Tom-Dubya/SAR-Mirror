...
function OcclusionSensitivity(dataPath, cnnNet, labelNames, utilisedLabel, imageSize, colorMap, alpha)
    arguments
    ...
    scoreMap = occlusionSensitivity(cnnNet, scaledImage, channel);
